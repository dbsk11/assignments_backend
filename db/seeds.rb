...
Assignment.create(task: "Answer questions 1-10", course: "Chemistry", grade: "98", teacher_id: 1, student_id: 1)
Assignment.create(task: "Complete the short response questions", course: "Chemistry", grade: "93", teacher_id: 1, student_id: 1)
Assignment.create(task: "Complete the handout", course: "Chemistry", grade: "95", teacher_id: 1, student_id: 1)
Assignment.create(task: "Answer all the even questions on page 28", course: "Chemistry", grade: "88", teacher_id: 1, student_id: 1)
Assignment.create(task: "Fill in the venn diagram", course: "Chemistry", grade: "82", teacher_id: 1, student_id: 1)
Assignment.create(task: "Answer questions 1-10", course: "Physics", grade: "98", teacher_id: 1, student_id: 1)
Assignment.create(task: "Complete the short response questions", course: "Physics", grade: "93", teacher_id: 1, student_id: 1)
Assignment.create(task: "Complete the handout", course: "Physics", grade: "95", teacher_id: 1, student_id: 1)
Assignment.create(task: "Answer all the even questions on page 28", course: "Physics", grade: "88", teacher_id: 1, student_id: 1)
Assignment.create(task: "Fill in the venn diagram", course: "Physics", grade: "82", teacher_id: 1, student_id: 1)
Assignment.create(task: "Answer questions 1-10", course: "AP Biology", grade: "98", teacher_id: 1, student_id: 1)
Assignment.create(task: "Complete the short response questions", course: "AP Biology", grade: "93", teacher_id: 1, student_id: 1)
Assignment.create(task: "Complete the handout", course: "AP Biology", grade: "95", teacher_id: 1, student_id: 1)
Assignment.create(task: "Answer all the even questions on page 28", course: "AP Biology", grade: "88", teacher_id: 1, student_id: 1)
Assignment.create(task: "Fill in the venn diagram", course: "AP Biology", grade: "82", teacher_id: 1, student_id: 1)
